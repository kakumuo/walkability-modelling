    ...
    return  <Box data-breakout className={props.className}>
        <Box className={styles.container}>
            ...
            <Box className={styles.banner}>
                <Button onClick={() => setShowSidebar(!showSidebar)}><IconLayoutSidebar /></Button>
...
function Sidebar(props:{show:boolean}){
    return <Box className={styles.sidebar + " " + (props.show ? styles.sidebarShow : styles.sidebarHide)}>
...
const styles = {
    ...
    sidebar:`flex flex-col h-full border p-4 bg-white`, 
    sidebarShow: `w-75`, 
    sidebarHide: `w-0 hidden`, 
